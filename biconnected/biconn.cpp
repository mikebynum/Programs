...
bool Graph::isBCUtil(int u, bool visited[], int disc[],int low[],int parent[])
{
    ...
    for (i = adj[u].begin(); i != adj[u].end(); ++i)
    {
        ...
        if (!visited[v])
        {
			...
			{	
               cout<<"u is root of DFS tree and has two or more chilren";
			   return true;
			}
			...
			{
				cout<<"u is not root and low value of one of its child is more than discovery value of u\n";
               return true;
		   }
        }
...
int main()
{
    ...
    Graph g4(5);
	cout<<"Create a graph with 5 edges\n";
    g4.addEdge(1, 0);
    g4.addEdge(0, 2);
    g4.addEdge(2, 1);
    g4.addEdge(0, 3);
