...
{
    T data=null;                        //data in node
    mbynum_ListNode<T> nextNode=null;   //next node section of node
...
public class mbynum_LinkedList <T extends Comparable<T>>
{
    ...
    //Method Name           :setFirstNode
    //Parameters            :a mbynum_ListNode<T. object called node
    //Return Values         :none
    //Partners              :none
    //Description           :sets the value of the first node
    public void setFirstNode(mbynum_ListNode<T> node)
    {
        firstNode=node;
    }//end setFirstNode
    //Method Name           :getFirstNode
    //Parameters            :none
    //Return Values         :T, a node
    //Partners              :none
    //Description           :returns a reference to the first node in the list
    public mbynum_ListNode<T> getFirstNode()
    {
        return firstNode;
    }
    //Method Name           :setLastNode
    //Parameters            :a mbynum_ListNode<T. object called node
    //Return Values         :none
    //Partners              :none
    //Description           :sets the value of the last node
    public void setLastNode(mbynum_ListNode<T> node)
    {
        lastNode=node;
    }
    ...
    //Return Values         :T, a node
    //Partners              :none
    //Description           :returns a reference to the last node in the list
    public mbynum_ListNode<T> getLastNode()
    {
        return lastNode;
    }
    //Method Name           :setNumElements
    //Parameters            :an integer called numElements
    //Return Values         :none
    //Partners              :none
    //Description           :sets the number of elements in the list
    public void setNumElements(Integer numElements)
    {
        this.numElements=numElements;
    }
    //Method Name           :getNumElements
    //Parameters            :none
    ...
    //Return Values         :none
    //Partners              :none
    //Description           :sets the name of the list
