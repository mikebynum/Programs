...
public class prog2 
{
    ...
    {
        Arrays.fill(queueNotSubmitted, 0);
        Arrays.fill(queueReady, 0);
        Arrays.fill(running, 0);
        Arrays.fill(quantumStatus, 0);
        Arrays.fill(processorIdle, 0);
        Arrays.fill(completed, 0);
        Arrays.fill(completeTimes, 0);
            ...
            //----------------------------------------------------------------*/
               ...
               //------------------------------------------------------------*/
                  ...
                  //--------------------------------------------------------*/
                     ...
                     System.out.println("Added process "+i+"to the ready queue");
                  /*----------------------------------------------------------
 ...
 /*   public static void printPriorityQueue(int numberProcess)                 
    ...
    public static int VIP(int Pnum, int numberProcess)                                                      
    {  
          ...
          /*check if the current job ran out of compute time*/
             ...
             //------------------------------------------------------------------*/
                ...
                //--------------------------------------------------------------*/
                   ...
                   System.out.printf("Process %d was moved to the blocked queue\n",blocked[j][0]);
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        */
        ...
        for (simulation = 0; simulation < simCounter; simulation++ )
        {
            ...
            for (int i =arrayPlaceholder; i<numberProcess; i++)
            {
                // Iterate through each array elemement
                // and copy to the not submitted yet
                for (int j=0; j<9; j++)
         ...
         //System.out.println("There are " + jobsLeft+ " jobs left after");
            ...
            for(int i=0; i<numberCPU; i++)
            {
               ...
               {
                 processorIdle[i]++;
                 System.out.println("The processorIdle is " +processorIdle);
               }
            }
